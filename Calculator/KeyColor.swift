...
#if os(macOS)
    private let digitColors             = ThreeColors(236.0/255.0, 125.0/255.0, 176.0/255.0)
    private let operatorColors          = ThreeColors(236.0/255.0, 101.0/255.0, 127.0/255.0)
    private let pendingOperatorColors   = ThreeColors(0.30, 0.90, 0.80)
    private let scientificColors        = ThreeColors(236.0/255.0, 101.0/255.0, 127.0/255.0)
