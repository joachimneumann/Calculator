...
struct Key: View {
    ...
    private let shapeNames: [String: AnyView] = [
        ...
        "10^x":     AnyView(Pow(base: "10",   exponent: "x",  additionalXOffset: 0.1)),
        "2nd":      AnyView(Pow(base: "2",    exponent: "nd", additionalXOffset: 0.0)),
        "asin":     AnyView(Pow(base: "sin",  exponent: "-1", additionalXOffset: 0.14)),
        "acos":     AnyView(Pow(base: "cos",  exponent: "-1", additionalXOffset: 0.2)),
        "atan":     AnyView(Pow(base: "tan",  exponent: "-1", additionalXOffset: 0.18)),
        "asinh":    AnyView(Pow(base: "sinh", exponent: "-1", additionalXOffset: 0.25)),
        "acosh":    AnyView(Pow(base: "cosh", exponent: "-1", additionalXOffset: 0.30)),
        "atanh":    AnyView(Pow(base: "tanh", exponent: "-1", additionalXOffset: 0.29)),
    ]
