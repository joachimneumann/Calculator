        ...
        WindowGroup {
            ZStack {
                GeometryReader { geo in
                    ...
                    iOSSize(size: geo.size, brain: brain, leadingPaddingNeeded: geo.safeAreaInsets.leading == 0, trailingPaddingNeeded: geo.safeAreaInsets.trailing == 0, bottomPaddingNeeded: geo.safeAreaInsets.bottom == 0)
