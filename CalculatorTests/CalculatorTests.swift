...
class CalculatorTests: XCTestCase {
    ...
    func testmultipleLiner() {
        ...
        var multipleLiner = MultipleLiner(left: "0", abbreviated: false)

        /// integers
        let lengthMeasurementResult = LengthMeasurementResult(withoutComma: 8, withCommaNonScientific: 9, withCommaScientific: 9, ePadding: 0)
        multipleLiner = brain.number("123").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "123")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("1234").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1234")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("12345").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("12300").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("123456").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("1234567").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1234567")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("12345678").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "12345678")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("123456789").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("1,234").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,234")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("1,2345").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,2345")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("1,23456").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,23456")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("1,234567").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,234567")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("1,2345678").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,2345678")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("1,23456789").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,2345678")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue(multipleLiner.abbreviated)
        ...
        multipleLiner = brain.number("-144,23456789").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "-144,2345")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("1445,23456789").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1445,2345")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("14456,23456789").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "14456,234")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("144567,23456789").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "144567,23")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("1445678,23456789").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1445678,2")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("14456785,23456789").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "14456785,")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,123").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,123")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("0,1234").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,1234")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("0,12345").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,12345")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("0,123456").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,123456")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("0,1234567").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,1234567")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,12345678").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,1234567")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,000012").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,000012")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,000004").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,000004")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,0000123456").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("-0,0000123").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "-0,000012")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)
        ...
        multipleLiner = brain.number("14456789,23456789").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("0,0123").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,0123")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,01234567").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,0123456")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,0012").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("0,001234567").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("0,0001234567").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("0,00001234567").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,0000123")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)
        ...
        multipleLiner = brain.number("1,5e12").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,5e12")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse( multipleLiner.abbreviated)

        multipleLiner = brain.gmpNumber("1,5e12").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,5")
        XCTAssertEqual(multipleLiner.right, "e12")
        XCTAssertFalse( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,00000004").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "4,0")
        XCTAssertEqual(multipleLiner.right, "e-8")
        XCTAssertFalse( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,0000004").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,0000004")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse( multipleLiner.abbreviated)

        multipleLiner = brain.number("12345678349875349873").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,2345")
        XCTAssertEqual(multipleLiner.right, "e19")
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("123456783498753498731").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "1,2345")
        XCTAssertEqual(multipleLiner.right, "e20")
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,012345678").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,0123456")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,0012345678").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,0012345")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertTrue( multipleLiner.abbreviated)
        ...
        multipleLiner = brain.number("921387491237419283092340238420398423098423049874129837649128364519234875").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "9,2138")
        XCTAssertEqual(multipleLiner.right, "e71")
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("1,23").multipleLines(lengthMeasurementResult)
        ...
        multipleLiner = brain.number("0,0023").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "0,0023")
        XCTAssertNil(  multipleLiner.right)
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("0,000000000023").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "2,3")
        XCTAssertEqual(multipleLiner.right, "e-11")
        XCTAssertFalse(multipleLiner.abbreviated)

        multipleLiner = brain.number("0,0000000000232837642876").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "2,328")
        XCTAssertEqual(multipleLiner.right, "e-11")
        XCTAssertTrue( multipleLiner.abbreviated)

        multipleLiner = brain.number("0,0000000000232837642876239827342").multipleLines(lengthMeasurementResult)
        XCTAssertEqual(multipleLiner.left, "2,328")
        XCTAssertEqual(multipleLiner.right, "e-11")
        XCTAssertTrue( multipleLiner.abbreviated)
    }
...
//        XCTAssertEqual(brain.scientific, DisplayData.Scientific("1,234567890123456789", "e19").multipleLines(lengthMeasurementResult)
//        
//        
//        /// -12345678901234
//        brain.nonWaitingOperation("AC")
...
//        brain.press(7)
//        XCTAssertEqual(brain.nonScientific, nil)
//        XCTAssertEqual(brain.scientific, DisplayData.Scientific("7,7777777777777777777777", "e22").multipleLines(lengthMeasurementResult)
//        
//        
//        
//        /// -123456789012345
...
//        brain.nonWaitingOperation("=")
//        XCTAssertEqual(brain.nonScientific, nil)
//        XCTAssertEqual(brain.scientific, DisplayData.Scientific("3,0", "e77").multipleLines(lengthMeasurementResult)
//        
//        /// 3 e-77
//        brain.nonWaitingOperation("AC")
//        brain.press(3)
...
//        brain.nonWaitingOperation("=")
//        XCTAssertEqual(brain.nonScientific, nil)
//        XCTAssertEqual(brain.scientific, DisplayData.Scientific("3,0", "e-77").multipleLines(lengthMeasurementResult)
//        
//        /// -3 e-77
//        brain.nonWaitingOperation("AC")
//        brain.press(3)
...
//        brain.press(0)
//        brain.nonWaitingOperation("=")
//        XCTAssertEqual(brain.debugLastGmp, Gmp("1024").multipleLines(lengthMeasurementResult)
...
//        XCTAssertEqual(brain.no, 1)
//        XCTAssertEqual(brain.nn, 2)
//        XCTAssertEqual(brain.debugLastGmp, Gmp("10").multipleLines(lengthMeasurementResult)
//        brain.nonWaitingOperation("=")
//        XCTAssertEqual(brain.debugLastGmp, Gmp("20").multipleLines(lengthMeasurementResult)
...
//        brain.nonWaitingOperation(")")
//        brain.nonWaitingOperation("=")
//        XCTAssertEqual(brain.debugLastGmp, Gmp("124").multipleLines(lengthMeasurementResult)
//        
//        /// 1+2=3
//        brain.nonWaitingOperation("AC")
//        brain.press(1)
