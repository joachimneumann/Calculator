...
class CalculatorTests: XCTestCase {
    ...
    func testOneLiner() {
        ...
        oneliner = Number("12300").oneLiner(length: 8)
        ...
        oneliner = Number("123456").oneLiner(length: 8)
        ...
        oneliner = Number("1234567").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1234567")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("12345678").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "12345678")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("123456789").oneLiner(length: 8)
        ...
        oneliner = Number("1,234").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1,234")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("1,2345").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1,2345")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("1,23456").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1,23456")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("1,234567").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1,234567")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("1,2345678").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1,234567")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue(oneliner.abreviated)
        ...
        oneliner = Number("-1,23456789").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "-1,23456")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("-144,23456789").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "-144,234")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("1445,23456789").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1445,234")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("14456,23456789").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "14456,23")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("144567,23456789").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "144567,2")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("1445678,23456789").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1445678,")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)
        
        oneliner = Number("0,123").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,123")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("0,1234").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,1234")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("0,12345").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,12345")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("0,123456").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,123456")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("0,1234567").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,123456")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("0,000012").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,000012")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse( oneliner.abreviated)

        oneliner = Number("0,000004").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,000004")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse( oneliner.abreviated)

        oneliner = Number("0,0000123456").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,000012")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("-0,000012").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "-0,00001")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)
        ...
        oneliner = Number("14456789,23456789").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "14456789")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("-144567,23456789").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "-144567,")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)
        ...
        oneliner = Number("0,0123").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,0123")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse( oneliner.abreviated)

        oneliner = Number("0,01234567").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,012345")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("0,0012").oneLiner(length: 8)
        ...
        oneliner = Number("0,001234567").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,001234")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("-0,001234567").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "-0,00123")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("0,0001234567").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,000123")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("-0,0001234567").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "-0,00012")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("0,00001234567").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,000012")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)
        ...
        oneliner = Number("0,12345678").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,123456")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)
        ...
        oneliner = Number(Gmp("1,5e12")).oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1,5")
        XCTAssertEqual(oneliner.right, "e12")
        XCTAssertFalse( oneliner.abreviated)

        oneliner = Number("0,0000004").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "4,0")
        XCTAssertEqual(oneliner.right, "e-7")
        XCTAssertFalse( oneliner.abreviated)

        oneliner = Number("12345678349875349873").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1,234")
        XCTAssertEqual(oneliner.right, "e19")
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("123456783498753498731").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "1,234")
        XCTAssertEqual(oneliner.right, "e20")
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("0,012345678").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,012345")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("0,0012345678").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,001234")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("-1445,23456789").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "-1445,23")
        XCTAssertNil(  oneliner.right)
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("921387491237419283092340238420398423098423049874129837649128364519234875").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "9,213")
        XCTAssertEqual(oneliner.right, "e71")
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("1,23").oneLiner(length: 8)
        ...
        oneliner = Number("0,0023").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "0,0023")
        XCTAssertNil(  oneliner.right)
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("0,000000000023").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "2,3")
        XCTAssertEqual(oneliner.right, "e-11")
        XCTAssertFalse(oneliner.abreviated)

        oneliner = Number("0,0000000000232837642876").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "2,32")
        XCTAssertEqual(oneliner.right, "e-11")
        XCTAssertTrue( oneliner.abreviated)

        oneliner = Number("0,0000000000232837642876239827342").oneLiner(length: 8)
        XCTAssertEqual(oneliner.left, "2,32")
        XCTAssertEqual(oneliner.right, "e-11")
        XCTAssertTrue( oneliner.abreviated)
    }
