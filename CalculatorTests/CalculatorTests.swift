...
class CalculatorTests: XCTestCase {
    ...
    func testrepresentation() {
        ...
        let r = Representations(characters1: 8, characters2: 20)

        r.update(Number("123"))
        XCTAssertEqual(r.r1.left, "123")
        XCTAssertNil(  r.r1.right)
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "123")
        XCTAssertNil(  r.r2.right)
        ...
        XCTAssertEqual(r.r1.left, "1234")
        XCTAssertNil(  r.r1.right)
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "1234")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("12345"))
        XCTAssertEqual(r.r1.left, "12345")
        XCTAssertNil(  r.r1.right)
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "12345")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertEqual(r.r1.left, "12300")
        XCTAssertNil(  r.r1.right)
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "12300")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertEqual(r.r1.left, "123456")
        XCTAssertNil(  r.r1.right)
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "123456")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertEqual(r.r1.left, "1234567")
        XCTAssertNil(  r.r1.right)
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "1234567")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number(Gmp("12345678")))
        XCTAssertEqual(r.r1.left, "12345678")
        XCTAssertNil(  r.r1.right)
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "12345678")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertEqual(r.r1.left, "1,234")
        XCTAssertNil(  r.r1.right)
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "1,234")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("1,23456789"))
        XCTAssertEqual(r.r1.left, "1,234567")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "1,23456789")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertEqual(r.r1.left, "-144,234")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "-144,23456789")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("1445,23456789"))
        XCTAssertEqual(r.r1.left, "1445,234")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "1445,23456789")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("14456,23456789"))
        XCTAssertEqual(r.r1.left, "14456,23")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "14456,23456789")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("144567,23456789"))
        XCTAssertEqual(r.r1.left, "144567,2")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "144567,23456789")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("1445678,23456789"))
        XCTAssertEqual(r.r1.left, "1,4456")
        XCTAssertEqual(r.r1.right, "e6")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "1445678,23456789")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)


        r.update(Number(Gmp("0,123")))
        XCTAssertEqual(r.r1.left, "0,123")
        XCTAssertNil(  r.r1.right)
        XCTAssertEqual(r.r2.left, "0,123")
        XCTAssertNil(  r.r2.right)

        r.update(Number(Gmp("0,123456789")))
        XCTAssertEqual(r.r1.left, "0,123456")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,123456789")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number(Gmp("0,0123")))
        XCTAssertEqual(r.r1.left, "0,0123")
        XCTAssertNil(  r.r1.right)
        XCTAssertEqual(r.r2.left, "0,0123")
        XCTAssertNil(  r.r2.right)

        r.update(Number(Gmp("0,01234567")))
        XCTAssertEqual(r.r1.left, "0,012345")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,01234567")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number(Gmp("0,0012")))
        XCTAssertEqual(r.r1.left, "0,0012")
        XCTAssertNil(  r.r1.right)
        XCTAssertEqual(r.r2.left, "0,0012")
        XCTAssertNil(  r.r2.right)
        ...
        XCTAssertEqual(r.r1.left, "0,001234")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,001234567")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number(Gmp("-0,001234567")))
        XCTAssertEqual(r.r1.left, "-0,00123")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "-0,001234567")
        XCTAssertNil(  r.r2.right)
        ...
        XCTAssertEqual(r.r1.left, "1,234")
        XCTAssertEqual(r.r1.right, "e-4")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,0001234567")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number(Gmp("-0,0001234567")))
        XCTAssertEqual(r.r1.left, "-1,23")
        XCTAssertEqual(r.r1.right, "e-4")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "-0,0001234567")
        XCTAssertNil(  r.r2.right)
        ...
        XCTAssertEqual(r.r1.left, "1,234")
        XCTAssertEqual(r.r1.right, "e-5")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,00001234567")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,12345678")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertEqual(r.r1.left, "1,234")
        XCTAssertEqual(r.r1.right, "e19")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "12345678349875349873")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("123456783498753498731"))
        XCTAssertEqual(r.r1.left, "1,234")
        XCTAssertEqual(r.r1.right, "e20")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "1,234567834987534")
        XCTAssertEqual(r.r1.right, "e20")
        XCTAssertTrue( r.r2.abreviated)

        r.update(Number("0,012345678"))
        XCTAssertEqual(r.r1.left, "0,012345")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,012345678")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,0012345678")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertEqual(r.r1.right, "e-5")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,000012345678")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("0,0000012345678"))
        XCTAssertEqual(r.r1.left, "1,234")
        XCTAssertEqual(r.r1.right, "e-6")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,0000012345678")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("-1445,23456789"))
        XCTAssertEqual(r.r1.left, "-1445,23")
        XCTAssertNil(  r.r1.right)
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "-1445,23456789")
        XCTAssertNil(  r.r2.right)
        ...
        XCTAssertEqual(r.r1.left, "9,213")
        XCTAssertEqual(r.r1.right, "e71")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "9,213874912374192")
        XCTAssertEqual(r.r2.right, "e71")
        XCTAssertTrue( r.r2.abreviated)
        ...
        XCTAssertEqual(r.r1.left, "0,0023")
        XCTAssertNil(  r.r1.right)
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,0023")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("0,000000000023"))
        XCTAssertEqual(r.r1.left, "2,3")
        XCTAssertEqual(r.r1.right, "e-11")
        XCTAssertFalse(r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "0,000000000023")
        XCTAssertNil(  r.r2.right)
        XCTAssertFalse(r.r2.abreviated)

        r.update(Number("0,0000000000232837642876"))
        XCTAssertEqual(r.r1.left, "2,32")
        XCTAssertEqual(r.r1.right, "e-11")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "2,32837642876")
        XCTAssertEqual(r.r2.right, "e-11")
        XCTAssertFalse(r.r2.abreviated)
        ...
        XCTAssertEqual(r.r1.right, "e-11")
        XCTAssertTrue( r.r1.abreviated)
        XCTAssertEqual(r.r2.left, "2,32837642876239")
        XCTAssertEqual(r.r2.right, "e-11")
        XCTAssertTrue( r.r2.abreviated)
    }
