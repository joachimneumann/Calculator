...
//    let digitsInSmallDisplay = TE(appFrame: CGSize, isPad: <#Bool#>).digitsInSmallDisplay
//    let brain = Brain()
//    
//    func test() throws {
//        let digits = 16
//        /// 0
//        brain.reset()
//        XCTAssertEqual(brain.mantissa(digits), "0")
...
//        XCTAssertEqual(brain.mantissa(digits), "1")
//        brain.digit(2, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "12")
//
//        // 01
//        brain.reset()
//        XCTAssertEqual(brain.mantissa(digits), "0")
...
//        brain.digit(4, digits: digits)
//        brain.digit(5, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "123456789012345")
//        XCTAssertEqual(brain.exponent(digits), nil)
//        brain.digit(6, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "1234567890123456")
//        XCTAssertEqual(brain.exponent(digits), nil)
//        brain.digit(7, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "1,2345678901234567")
...
//        XCTAssertEqual(brain.mantissa(digits), "-12345678901234")
//
//
//        /// 77777777777777777
//        brain.reset()
...
//        brain.digit(7, digits: digits)
//        brain.digit(7, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "777777777")
//        XCTAssertEqual(brain.exponent(digits), nil)
//        XCTAssertEqual(brain.mantissa(digits), "777777777")
//        XCTAssertEqual(brain.exponent(digits), nil)
//        brain.digit(7, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "7777777777")
//        XCTAssertEqual(brain.exponent(digits), nil)
//        XCTAssertEqual(brain.mantissa(digits), "7777777777")
//        XCTAssertEqual(brain.exponent(digits), nil)
//        brain.digit(7, digits: digits)
...
//        brain.digit(7, digits: digits)
//        brain.digit(7, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "7,7777777777777777")
//        XCTAssertEqual(brain.exponent(digits), "e16")
//        brain.digit(7, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "7,77777777777777777")
...
//        brain.digit(6, digits: digits)
//        brain.operationWorker("+/-")
//        XCTAssertEqual(brain.mantissa(digits), "-1,234567890123456")
//        XCTAssertEqual(brain.exponent(digits), "e15")
//
//        /// +/-
//        brain.reset()
//        brain.digit(7, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "7")
//        brain.operationWorker("+/-")
//        XCTAssertEqual(brain.mantissa(digits), "-7")
//
//        /// -0,7
...
//        XCTAssertEqual(brain.mantissa(digits), "0,")
//        brain.digit(7, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "0,7")
//        brain.operationWorker("+/-")
//        XCTAssertEqual(brain.mantissa(digits), "-0,7")
//
//        brain.reset()
...
//        brain.operationWorker("+/-")
//        brain.operationWorker("=")
//        XCTAssertEqual(brain.mantissa(digits), "3,0")
...
//        brain.digit(8, digits: digits)
//        brain.digit(8, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "8888888")
//        XCTAssertEqual(brain.mantissa(digits), "8888888")
//
//        
//        /// memory
...
//        XCTAssertEqual(brain.mantissa(digits), "12")
//        brain.getMemory()
//        XCTAssertEqual(brain.mantissa(digits), "24")
...
//        XCTAssertEqual(brain.mantissa(digits), "0,")
//        brain.zero(digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "0,0")
//        brain.zero(digits: digits)
//        brain.zero(digits: digits)
//        brain.zero(digits: digits)
//        brain.zero(digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "0,00000")
//        brain.digit(1, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "0,000001")
//        brain.zero(digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "0,0000010")
//
//        /// reset
//        brain.reset()
//        XCTAssertEqual(brain.mantissa(digits), "0")
...
//            res += "0"
//            brain.zero(digits: digits)
//            XCTAssertEqual(brain.mantissa(digits), res)
//        }
//        brain.digit(1, digits: digits)
//        XCTAssertEqual(brain.mantissa(digits), "1,0")
...
//        brain.digit(4, digits: digits)
//        res = "32456,2244"
//        XCTAssertEqual(brain.mantissa(digits), "32456,2244")
//        
...
//            XCTAssertEqual(brain.mantissa(digits), String(res.prefix(digitsInSmallDisplay+1)))
//        }
//
...
//        brain.digit(9, digits: digits)
//        brain.operationWorker("%")
//        XCTAssertEqual(brain.mantissa(digits), "0,09")
//        brain.operationWorker("%")
//        XCTAssertEqual(brain.mantissa(digits), "0,0009")
//        brain.operationWorker("%")
//        brain.operationWorker("%")
...
//        XCTAssertEqual(brain.mantissa(digits), String(correct.prefix(digitsInSmallDisplay+1)))
//        let c = brain.mantissa(correct.count)!
...
//        brain.operationWorker("π")
//        XCTAssertEqual(brain.debugLastDouble, Double.pi)
//        XCTAssertEqual(brain.mantissa(digits), String("3,1415926535897932384626433832795028841971".prefix(digitsInSmallDisplay+1)))
//        brain.operationWorker("=")
//        XCTAssertEqual(brain.debugLastDouble, 1.0+Double.pi)
//        XCTAssertEqual(brain.mantissa(digits), String("4,1415926535897932384626433832795028841971".prefix(digitsInSmallDisplay+1)))
//
//        /// 1/10 and 1/16
//        brain.reset()
//        brain.digit(1, digits: digits)
...
//        XCTAssertEqual(brain.mantissa(digits), "10")
//        brain.operationWorker("One_x")
